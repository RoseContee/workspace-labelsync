                        ...
                        <form action="{{ $route }}" method="POST">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="paypal_plan_id">PayPal Plan ID <span class="required">*</span></label>
                                        <input type="text" id="paypal_plan_id" name="paypal_plan_id" autocomplete="off"
                                               class="form-control @error('paypal_plan_id') is-invalid @enderror"
                                               value="{{ old('paypal_plan_id', $membership['paypal_plan_id'] ?? '') }}"
                                               placeholder="PayPal Plan ID" required>
                                        @error('paypal_plan_id')
                                            <label for="paypal_plan_id" class="text-danger small mb-0 font-weight-normal">
                                                {{ $message }}
                                            </label>
                                        @enderror
                                    </div>
