                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($license['subscription_id'])
                                            <div id="expires_on" class="form-control"></div>
                                        @else
                                    ...
                                    @if (!$license['subscription_id'])
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="subscription_id" name="subscription_id"
                                                   ...
                                                   value="{{ old('subscription_id', $license['subscription_id']) }}"
                                                   placeholder="Transaction...">
                                            @error('subscription_id')
                                                <label for="subscription_id" class="text-danger small mb-0 font-weight-normal">
                                                    {{ $message }}
                                                </label>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select id="payment_method" name="payment_method"
                                                ...
                                                @php $old = old('payment_method', $license['payment_method']) @endphp
                                                <option value=""></option>
                                                <option value="paypal" @if($old === 'paypal') selected @endif>PayPal</option>
                                            </select>
                                            @error('payment_method')
                                                <label for="payment_method" class="text-danger small mb-0 font-weight-normal">
                                                    {{ $message }}
                                                </label>
                                            @enderror
                                        </div>
...
@push('scripts')
    <script type="text/javascript">
        $(() => {
            ...
            @endphp
            @if ($license['subscription_id'])
                $('#expires_on').text(dateTimeFormat({{ $default_expires_on }}))
            @else
